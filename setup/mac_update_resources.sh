...
mkdir $app/Contents/Resources/py/cuda_tree_markdown
...
rm -rf $from/py/cuda_tree_markdown/__pycache__
cp -rf $from/py/cuda_tree_markdown/* $app/Contents/Resources/py/cuda_tree_markdown
