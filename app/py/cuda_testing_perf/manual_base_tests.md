...
you will have to revert the original wrap_enabled_max_lines, wrap_mode and scrollbar_themed manually in user.json, this manual test does not backup/restore them
