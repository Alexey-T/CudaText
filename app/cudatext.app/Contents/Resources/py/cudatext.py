...
class Editor:
    ...
    def folding(self, id, index=-1, x=-1, y=-1, y2=-1, staple=False, hint='', x2=0, tag=0):
        return ct.ed_folding(self.h, id, index, x, y, x2, y2, staple, hint, tag)
